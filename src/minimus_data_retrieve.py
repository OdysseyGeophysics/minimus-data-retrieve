import os
from src.query_input_yes_no import query_yes_no
import glob
...
# Path to the data
data_path = '/Volumes/T7/'

# path to IRIS dataless seed to stationxml converter
seed_xml_conv_path = "/Users/ashbycooper/opt/seed_stationxml_converter/stationxml-seed-converter-2.1.0.jar "
